...
describe('anyclipBidAdapter', () => {
  ...
  describe('isBidRequestValid', function () {
    ...
    it('should return false when required publisherId param is missing', function () {
      const invalidRequest = deepClone(defaultRequest);
      delete invalidRequest.params.publisherId;
      expect(spec.isBidRequestValid(invalidRequest)).to.equal(false);
    });

    it('should return false when required supplyTagId param is missing', function () {
      const invalidRequest = deepClone(defaultRequest);
      delete invalidRequest.params.supplyTagId;
      expect(spec.isBidRequestValid(invalidRequest)).to.equal(false);
    });
